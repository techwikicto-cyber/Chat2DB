export default {
  'license.selectActivationType': 'Seleccione el tipo de activación',
  'license.onlineActivation': 'Activación en línea',
  'license.offlineActivation': 'Activación sin conexión',
  'license.deviceId': 'ID del dispositivo',
  ...
  'license.certificateDescription':
  ...
  'license.certificateNote': 'Los certificados generados se pueden copiar en [Detalles de compra]',
  'license.modalTitle': 'Se ha generado el certificado del dispositivo',
  'license.modalTitleDesc': 'También puede copiarlo en [Detalles de compra] en cualquier momento',
