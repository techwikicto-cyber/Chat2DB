export default {
  ...
  'common.error.databaseUnreachable': 'The database could not be reached',
  'common.error.modelUnreachable': 'The AI model service could not be reached',
  'common.error.sshUnreachable': 'The SSH tunnel could not be established',
  'common.error.driverLoad': 'The database driver could not be loaded',
  'common.error.assistantStopped': 'The assistant stopped',
  'common.error.technicalDetail': 'Check that the server is running and reachable from here. Technical detail: {1}',
