export default {
  'ai.error.databaseUnreachableNamed': '无法连接到数据库“{1}”，因此没有读取任何数据。这是连接问题，不是助手的能力限制——请检查数据库服务器后重试。',
  'ai.error.modelUnreachable': '无法连接到 AI 模型服务。你的数据库没有问题；请检查模型提供方设置和网络后重试。',
