export default {
  ...
  'knowledgeManagement.terminology.description':
    'به پلتفرم بینا کمک می‌کند توضیح هدف شما را در فرایند داده‌کاوی بهتر بفهمد. می‌توانید واژگان تخصصی خود را اینجا وارد کنید (امکان تعیین منبع داده وجود دارد، در غیر این صورت اثر سراسری دارد).',
  ...
  'knowledgeManagement.businessLogic.description':
    'به پلتفرم بینا کمک می‌کند منطق کسب‌وکار موجود در پایگاه‌داده شما را بهتر بفهمد. می‌توانید منطق را با جزئیات اینجا وارد کنید (امکان تعیین منبع داده وجود دارد، در غیر این صورت اثر سراسری دارد).',
  ...
  'knowledgeManagement.annotationTable.description':
    'پلتفرم بینا امکان حاشیه‌نویسی دقیق فیلدهای جدول‌های پایگاه‌داده را فراهم می‌کند. این کار به هوش مصنوعی کمک می‌کند معنای هر فیلد را بهتر بفهمد و دقت پردازش و تحلیل داده را بالا ببرد.',
  'knowledgeManagement.label.batchOperation': 'عملیات گروهی',
  'knowledgeManagement.label.batchImport': 'افزودن گروهی',
  'knowledgeManagement.label.batchExport': 'استخراج گروهی',
  ...
  'knowledgeManagement.label.batchExportAll': 'استخراج گروهی همه',
  ...
  'knowledgeManagement.tips.exportSuccess': '{1} مورد با موفقیت استخراج شد',
