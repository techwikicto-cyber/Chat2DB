export default {
  ...
  'common.error.databaseUnreachable': 'データベースに接続できませんでした',
  'common.error.modelUnreachable': 'AI モデルサービスに接続できませんでした',
  'common.error.sshUnreachable': 'SSH トンネルを確立できませんでした',
  'common.error.driverLoad': 'データベースドライバーを読み込めませんでした',
  'common.error.assistantStopped': 'アシスタントが停止しました',
  'common.error.technicalDetail': 'サーバーが稼働し、ここから到達できることを確認してください。技術的な詳細: {1}',
