...
- **تنظیمات مدل‌های هوش مصنوعی هنوز مشترک است.** فایل `ai-model-configs.json` بیرون از فضاهای کاری است، پس همه‌ی حساب‌ها یک پیکربندی مشترک دارند و هر کسی می‌تواند عوضش کند. کلید API در پاسخ‌های API ماسک می‌شود و متن آن به کسی نشان داده نمی‌شود، ولی همه از همان کلید استفاده می‌کنند.
